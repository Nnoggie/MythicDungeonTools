...
function MDT:MakeSettingsFrame(frame)
  ...
  frame.teleportCheckbox = AceGUI:Create("CheckBox")
  frame.teleportCheckbox:SetLabel(L["Dungeon Teleport on Right Click"])
  frame.teleportCheckbox:SetWidth(frameWidth - 10)
  frame.teleportCheckbox:SetValue(db.enableDungeonTeleport)
  frame.teleportCheckbox:SetCallback("OnValueChanged", function(widget, callbackName, value)
    db.enableDungeonTeleport = value
    MDT:UpdateDungeonDropDown()
  end)
  frame.settingsFrame:AddChild(frame.teleportCheckbox)
