...
--TODO: check week 1 as week 2 was completely different from week 1 (not the usual 1 swap)
...
MethodDungeonTools.dungeonEnemies[dungeonIndex] = {
    ...
    [11] = {
        ...
        ["creatureType"] = "Mechanical";
        ["level"] = 122;
        ["name"] = L["Head Machinist Sparkflux"];
        ["count"] = 0;
    };
    [22] = {
        ["clones"] = {
