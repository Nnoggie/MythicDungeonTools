...
MethodDungeonTools.dungeonTotalCount[dungeonIndex] = {normal=305,teeming=335,teemingEnabled=true}
...
MethodDungeonTools.dungeonEnemies[dungeonIndex] = { --Cathedral of Eternal Night
	...
	[4] = {
		["name"] = string.format("%s %s", L["Felguard Destroyer"], L["(No Count)"]),
		["health"] = 14906986,
		["level"] = 110,
		["creatureType"] = "Demon",
		["id"] = 120770,
	...
	[5] = {
		["name"] = string.format("%s %s", L["Helblaze Felbringer"], L["(No Count)"]),
		["health"] = 13153223,
		["level"] = 110,
		["creatureType"] = "Demon",
		["id"] = 120779,
	...
	[6] = {
		["name"] = string.format("%s %s", L["Wrathguard Invader"], L["(No Count)"]),
		["health"] = 14906986,
		["level"] = 110,
		["creatureType"] = "Demon",
		["id"] = 120778,
