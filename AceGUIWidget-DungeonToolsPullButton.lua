...
local function Constructor()
    ...
    pickedGlow:SetTexture("Interface\\AddOns\\DungeonTools\\Textures\\HeartOfAzerothSelection")
    ...
    for i=1,maxPortraitCount do
        ...
        enemyPortraits[i].overlay:SetTexture("Interface\\Addons\\DungeonTools\\Textures\\Circle_White")
    ...
    reapingIcon.overlay:SetTexture("Interface\\Addons\\DungeonTools\\Textures\\Circle_White")
