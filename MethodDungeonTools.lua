...
function MethodDungeonTools:MakeSidePanel(frame)
    ...
    frame.sidePanelNewButton.frame:SetScript("OnEnter",function()
        ...
        GameTooltip:AddLine("Create a new the preset.",1,1,1)
        GameTooltip:Show()
    end)
    ...
    frame.sidePanelImportButton.frame:SetScript("OnEnter",function()
        ...
        GameTooltip:AddLine("You can find MDT exports from other users on the wago.io website.",1,1,1)
        GameTooltip:Show()
    end)
    ...
    frame.sidePanelExportButton.frame:SetScript("OnEnter",function()
        ...
        GameTooltip:AddLine("You can share MDT exports on the wago.io website.",1,1,1)
        GameTooltip:Show()
    end)
    ...
    frame.LiveSessionButton.frame:SetScript("OnEnter",function()
        ...
        GameTooltip:AddLine("Clicking this button will attempt to join the ongoing Live Session or create a new one if none is found.",1,1,1,1)
        GameTooltip:AddLine("Players can join your live session by either clicking this button or the Live Session Link in the chat.",1,1,1,1)
        GameTooltip:AddLine("To share a different preset while the live session is active simply navigate to the preset and click the new 'Set to Live' Button next to the preset-dropdown",1,1,1,1)
    ...
    frame.sidePanel.DifficultySlider:SetLabel("")
