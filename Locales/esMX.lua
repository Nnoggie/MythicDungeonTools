...
L["Please report any bugs on https://github.com/Tomslack/ManbabyDungeonTools/issues"] = "Por favor, informe de cualquier error en https://github.com/Tomslack/ManbabyDungeonTools/issues"
