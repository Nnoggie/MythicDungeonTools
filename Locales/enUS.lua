...
L["Please report any bugs on https://github.com/Tomslack/ManbabyDungeonTools/issues"] = "Please report any bugs on https://github.com/Tomslack/ManbabyDungeonTools/issues"
