...
L["LargePresetWarning"] =
  "You are trying to share a very large route (%d characters)%sIt is recommended to use the export function and share large routes through external websites instead.%sAre you sure you want to share this route?%s"
...
L["tuskarrCage"] = "You must free the tuskarr inside this cage."
