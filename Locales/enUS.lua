...
L["brewItemADescription"] = "" --To DO:Usable by Gnome, Mechagnome, Goblin, and Khaz Algar Engineers (25)
L["brewItemBDescription"] = "" --To DO:Usable by Khaz Algar Alchemy (25) or Khaz Algar Cooking (25)
L["Voidstone Awakened"] = "Voidstone Awakened"
L["darkflamespawns"] = "" --To DO:The enemy will spawn after the mine cart event.
L["darkflamedespawns"] = "" --To DO:Unkilled enemy in this area will despawns after the mine cart event.
L["darkflamepatrolbug"] = "" --To DO:Patrol path bug: falls out of the map and teleports back after about 20 seconds.
L["priory1bossnote"] = "" --To DO:The adjutant (Elite adds near the boss) in the boss fight does not count
