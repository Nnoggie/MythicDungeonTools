...
L["Please report any bugs on https://github.com/Tomslack/ManbabyDungeonTools/issues"] = "Ti preghiamo di segnalare eventuali bug all'indirizzo: https://github.com/Tomslack/ManbabyDungeonTools/issues"
